...
*A robust SPA for task management with persistent data storage.*
- **Tech Stack:** React, Python, Flask, PostgreSQL (or SQLAlchemy).
...
- [🔗 Visit Portfolio](https://www.mcontreras.dev) | [📁 Source Code](https://github.com/mcontrerasdevpro/portfolio-Miguel-Contreras)
...
- 🧪 **Testing:** Unit & Integration (Jest / PyTest).
- ⚙️ **DevOps:** CI/CD Pipelines & Cloud Deployment (AWS/Azure).
